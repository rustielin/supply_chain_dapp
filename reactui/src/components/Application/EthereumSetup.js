...
var supplyAddress = '0x21eb4df0e20e4d0ba65fdf4a483cdcd9cef034c8';
...
// var addresses = supplyContract.addresses();
// var mappings = supplyContract.mappings();

// for (int i = 0 i <)

alert(disp);

export {web3, supplyContract, disp};
